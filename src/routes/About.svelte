...
>
	<article class="prose text-center leading-loose break-normal prose-a:font-bold prose-a:no-underline">
		...
		<p class="leading-tight text-xs">(a.k.a. <i>John Slavik</i>, if that's easier for you to remember)</p>
		...
		<span class="inline-block w-full text-center">
			...
			<a
				...
				class="mt-4 inline-block rounded-full border border-gray-300 p-4 text-xl transition-all duration-500 hover:shadow-2xl"
				aria-label="E-mail"
